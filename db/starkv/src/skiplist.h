...
#ifndef STARDB_TSKIPLIST_H
#define STARDB_TSKIPLIST_H
...
#define SKIP_LIST_RECORD_PERFORMANCE 1
...
typedef struct SSkipList {
  ...
  SkipListState state;  // skiplist state
#endif
} SSkipList;
 ...
 * @return
 */
SSkipList *skipListCreate(uint8_t nMaxLevel, uint8_t keyType, uint8_t keyLen, uint8_t dupKey, uint8_t threadsafe,
 ...
 * @return
 */
SArray *skipListGet(SSkipList *pSkipList, SSkipListKey pKey);
