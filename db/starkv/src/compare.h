...
#ifndef STARDB_COMPARE_H
#define STARDB_COMPARE_H
...
#define STAR_PATTERN_MATCH 0
#define STAR_PATTERN_NOMATCH 1
#define STAR_PATTERN_NOWILDCARDMATCH 2
#define STAR_PATTERN_STRING_MAX_LEN 20
