...
versioninfo="${top_dir}/src/os/version.cc"
...
if [ "$verMode" == "cluster" ]; then
  libstardb_info=${tmp_version}_${osType}_${cpuType}
else
  libstardb_info=edge_${tmp_version}_${osType}_${cpuType}
fi
if [ "$verType" == "beta" ]; then
  libstardb_info=${libstardb_info}_${verType}
fi
echo "void libstardb_${libstardb_info}() {};"        >> ${versioninfo}
