...
class RpcMeta final :
 ...
 public:
  ...
  template <typename ArgT0 = const std::string&, typename... ArgT>
  void set_method_id(ArgT0&& arg0, ArgT... args);
  ...
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_method_id(const std::string& value);
...
void RpcMeta::set_service_id(ArgT0&& arg0, ArgT... args) {
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void RpcMeta::set_method_id(ArgT0&& arg0, ArgT... args) {
 
 method_id_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void RpcMeta::_internal_set_method_id(const std::string& value) {
  ...
  method_id_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* RpcMeta::_internal_mutable_method_id() {
  
  return method_id_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* RpcMeta::release_method_id() {
  // @@protoc_insertion_point(field_release:srpc.RpcMeta.method_id)
  return method_id_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
inline void RpcMeta::set_allocated_method_id(std::string* method_id) {
  ...
  method_id_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), method_id,
      GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (method_id_.IsDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited())) {
